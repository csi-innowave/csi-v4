  ...
  useEffect(() => {
    ...
    refs.forEach((r, i) => {
      if (r.current) {
        ...
        if (i === 0) {
          r.current.classList.add('is-active');
        } else {
          r.current.classList.remove('is-active');
        }
      }
    });
    ...
    const swap = () => {
      ...
      const newFront = refs[rest[0]]?.current;
      if (newFront) {
        newFront.classList.add('is-active');
      }
      elFront.classList.remove('is-active');
